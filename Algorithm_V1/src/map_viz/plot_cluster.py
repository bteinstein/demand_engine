...
# Generate and save the map with depot marker
...
def vis_and_save(df_routes, 
    ...
    """
    This function is designed to visualize and save the clustered routes on a Folium map.
    It allows for customization of the cluster column, popup and tooltip columns, and depot marker size
    while providing an option to save the map to a file.
    """
