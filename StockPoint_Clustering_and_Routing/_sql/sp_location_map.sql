SELECT DISTINCT 
        ...
        INNER JOIN  VCONNECTMASTERDWR..Stock_Point_Master sp WITH (NOLOCK) ON fm.Fulfilement_Center_ID = sp.Stock_Point_ID AND  sp.Fulfilement_Center_ID = 76
        WHERE 
        fm.[status] = 1 -- Active
        AND  fm.Location_Type = 3 -- LCDA AND  lgm.CountryID = 1
